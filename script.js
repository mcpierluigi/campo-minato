...
// FUNZIONI UTILI ALLA LOGICA DI GIOCO

//Funzione per l'aggiornamento del punteggio:
function updateScore() {
  // Incremento
  score++;
  // Lo inserisco nel contatore
  //pedStart: voglio 5 elementi, se non ci sono il resto sono 0
...
function endGame(isVictory) {
  if (isVictory === true) {
    ...
    // Riveliamo tutte le bombe con la funzione apposita
    revealAllBombs();
  }
